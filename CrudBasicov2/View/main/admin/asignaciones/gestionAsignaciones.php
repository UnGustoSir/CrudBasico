    ...
    <div id="mostrar"></div>
        ...
        <div class="content">
            <div class="text-center py-4">
                                ...
                                foreach($arrayAsig as $result){
                                    echo '<tr>';
                                        ...
                                        echo '<td class="d-flex justify-content-center gap-2">
                                            <a action="deleteAsig" tControl="asig" idElem="'.$result['idAsig'].'" href="#" class="btn btn-danger btn-sm deleteBtn">Eliminar</a>
                                            <a href="../CrudBasico?typeControl=asig&a=vistaUpdate&idAsig='.$result['idAsig'].'&user='.$user.'" class="btn btn-warning btn-sm">Modificar</a>
                                        </td>';
                                    echo '</tr>';
                                }
                            ?>
                ...
                <div class="mt-4">
                    <a href="../CrudBasico?typeControl=asig&a=vistaInsert&user=<?php echo $user?>" class="btn btn-success">Insertar Asignación</a>
