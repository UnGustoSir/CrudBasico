    ...
    <?php include('../CrudBasico/View/Extra/sidebard.php')?>
        ...
        <div class="content">
            <div class="text-center py-4">
                                ...
                                foreach($arrayUsers as $result){
                                    echo '<tr>';
                                        ...
                                        echo '<td class="d-flex justify-content-center gap-2">';
                                            ...
                                            echo '<a href="../CrudBasico?typeControl=usuarios&a=vistaModif&idUser='.$result['idUser'].'&user='.$user.'" class="btn btn-warning btn-sm">Modificar</a>';
                                        echo '</td>';
                                    echo '</tr>';
                                }
                            ?>
                ...
                <!-- Botones de acción -->
                <div class="mt-4">
                    <a href="../CrudBasico?typeControl=usuarios&a=vistaInsert&user=<?php echo $user?> " class="btn btn-success">Insertar Usuario</a>
